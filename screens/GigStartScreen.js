import { View, Text, Pressable, Linking, Alert, Button } from "react-native";
	...
	return (
		<View style={STARTGIG.screenWrapper}>
			...
			<View style={STARTGIG.mapWrapper}>
				...
				<Button on onPress={() => goToStart()} title="Go to start"/>
				<Button on onPress={() => goToEnd()} title="Go to end"/>
			</View>
